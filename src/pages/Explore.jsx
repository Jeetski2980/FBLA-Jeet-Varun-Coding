      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-12">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-white/10 border border-white/20 rounded-[24px] pl-14 pr-6 py-4 text-white focus:outline-none focus:ring-2 focus:ring-primary/20 shadow-2xl placeholder:text-white"
          />
        </div>
