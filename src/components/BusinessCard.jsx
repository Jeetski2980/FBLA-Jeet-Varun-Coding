  ...
  return (
    <div className="relative group">
      ...
      <div className="p-4">
        ...
        <h3 className="text-lg font-black mb-1 group-hover:opacity-80 transition-opacity" style={{ color: '#111111' }}>
          {business.name}
        </h3>

        <div className="flex flex-wrap items-center gap-3 text-slate-400 text-[10px] font-bold mb-3">
